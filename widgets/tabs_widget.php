<?php
if( ! class_exists( 'Fusion_Pyre_Tabs_Widget' ) ) {
	add_action('widgets_init', 'fusion_pyre_tabs_load_widgets');

	function fusion_pyre_tabs_load_widgets()
	{
		register_widget('Fusion_Pyre_Tabs_Widget');
	}

	class Fusion_Pyre_Tabs_Widget extends WP_Widget {

		function Fusion_Pyre_Tabs_Widget()
		{
